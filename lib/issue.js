...
Issue.getUrl = function(project, issueId) {
	...
	var parsedIssueId = parseInt(issueId, 10);
	if (isNaN(parsedIssueId) || (parsedIssueId < 1)) {
		return null;
	}
	return 'http://code.google.com/p/' + project.toLowerCase() + '/issues/detail?id=' + parsedIssueId;
};
